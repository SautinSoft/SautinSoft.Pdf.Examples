...
namespace Sample
{
    ...
    {
        /// <remarks>
        /// Details: https://sautinsoft.com/products/pdf/help/net/developer-guide/convert-pdf-to-pdf-a.php
        /// </remarks>
        ...
        static void Main(string[] args)
        {
            ...
            using (var document = PdfDocument.Load(pdfFile))
            {
                ...
                // PdfSaveOptions for the output PDF result.
                var pdfOtions = new PdfSaveOptions()
                {
                ...
                document.Save("Embedded Files from file system.pdf", pdfOtions);
            }
