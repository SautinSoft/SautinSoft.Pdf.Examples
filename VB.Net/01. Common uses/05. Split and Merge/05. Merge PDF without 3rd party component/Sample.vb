...
Namespace Sample
	Friend Class Sample
		...
		''' </summary>
		''' <remarks>
		''' Details: https://sautinsoft.com/products/pdf/help/net/developer-guide/combine-merge-multiple-PDF-without-3rd-party-component-csharp-dotnet.php
		''' </remarks>
		Shared Sub Main(ByVal args() As String)
			...
			' https://sautinsoft.com/products/pdf/help/net/developer-guide/merge-pdf-files.php
